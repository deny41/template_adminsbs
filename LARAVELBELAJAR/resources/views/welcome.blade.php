            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#body">
                        <h1 id="logo">
                            <img src="{{ asset ('assets_frontend/img/logo.png')}}" alt="Brandi">
                        </h1>
                    </a>
                    <!-- /logo -->
                </div>
        ...
        <section id="slider">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <!-- single slide -->
                    <div class="item active" style="background-image: url(assets_frontend/img/banner.jpg); height: 100%">
        ...
        <section id="works" class="works clearfix">
            ...
            <div class="project-wrapper">
                ...
                <figure class="mix work-item branding">
                    <img src="{{ asset ('assets_frontend/img/works/item-1.jpg')}}" alt="">
                    <figcaption class="overlay">
                        <a class="fancybox" rel="works" title="Write Your Image Caption Here" href="{{ asset ('assets_frontend/img/works/item-1.jpg')}}"><i class="fa fa-eye fa-lg"></i></a>
                ...
                <figure class="mix work-item web">
                    <img src="{{ asset ('assets_frontend/img/works/item-2.jpg')}}" alt="">
                    <figcaption class="overlay">
                        <a class="fancybox" rel="works" title="Write Your Image Caption Here" href="{{ asset ('assets_frontend/img/works/item-2.jpg')}}"><i class="fa fa-eye fa-lg"></i></a>
                        <h4>Labore et dolore magnam</h4>
                        <p>Photography</p>
                    </figcaption>
                </figure>
                ...
                <figure class="mix work-item logo-design">
                    <img src="{{ asset ('assets_frontend/img/works/item-3.jpg')}}" alt="">
                    <figcaption class="overlay">
                ...
                <div class="row">
                    ...
                    <figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms">
                        <div class="member-thumb">
                            <img src="{{ asset ('assets_frontend/img/team/member-1.png')}}" alt="Team Member" class="img-responsive">
                            <figcaption class="overlay">
                    ...
                    <figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="300ms">
                        <div class="member-thumb">
                            <img src="{{ asset ('assets_frontend/img/team/member-2.png')}}" alt="Team Member" class="img-responsive">
                            <figcaption class="overlay">
                                <h5>voluptatem quia voluptas </h5>
                                <p>sit aspernatur aut odit aut fugit,</p>
                                <ul class="social-links text-center">
                    ...
                    <figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="600ms">
                        <div class="member-thumb">
                            <img src="{{ asset ('assets_frontend/img/team/member-3.png')}}" alt="Team Member" class="img-responsive">
                            <figcaption class="overlay">
                                <h5>voluptatem quia voluptas </h5>
                                <p>sit aspernatur aut odit aut fugit,</p>
                                <ul class="social-links text-center">
